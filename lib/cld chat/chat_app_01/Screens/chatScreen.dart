...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Future<void> _loadReceiverProfile() async {
    ...
    if (chatService.currentChatId != null) {
      print('current id  ---->>>  ${chatService.currentChatId}');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        leadingWidth: 100, // 👈 Increase this if needed
        leading: _receiverProfile != null
          ...
          children: [
            IconButton(
              onPressed: () {
                final chatService = Provider.of<ChatService>(context, listen: false);
                chatService.setCurrentChat(' '); // or '' if you're using empty string
            ...
            CircleAvatar(
              radius: 16, // 👈 Smaller radius (32px total, fits in leading area)
        ...
        title: _receiverProfile != null
            ? Text(_receiverProfile!['display_name'])
        // :print('_recieverProfile--->>>$_receiverProfile');
            : Text(_receiverProfile!['display_name']),
